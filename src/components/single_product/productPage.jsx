...
const singleprd1 =
  
  {
    ...
    description:"Nam tempus turpiso metus scelerisque placerat nulla deumantos solicitud fells.Pellentesquediam dolor, elementum etos lobortis...",
    detail:"Vendor: Anna",
  ...
  const recentimage =[
    {
      image:image37, heading:"JIMMY CHOO",
      content:"(Product6) Sample-Clothing And Accessory Boutiques For Sale",
      rate:"$86.00"
    },
    {
      ...
      <div className='single'>
        <div className='container'>
          <div className='row'>
            ...
            <SingleProductLeft singleproductimages={singleproductimages}/>
            </div>
            <div className='col-md-6 spliter2'>
              <SingleProduct  item={singleprd1}/>
            </div>
            ...
            <TabPanel value="1">
              ...
              <div id='unorder'>
                ...
                <ul>
                  ...
                  <li>The discovery of the text's origin is attributed to Richard McClintock</li>
                </ul>
              </div>
              <div id='ordered'>
