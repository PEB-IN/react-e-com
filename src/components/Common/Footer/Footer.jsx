      ...
      <div className='container gap'>
          <div className='row'>
              <div className='col-md-3'>
                <h5>DRESS</h5>
                <p id='quality'>design which can be worn with various accessories to 
                suit different occasions.</p>
              </div>
              <div className='col-md-2'>
                <h5>SHOP</h5>
                <h6><a id='next' href='#'>All Collections</a></h6>
                <h6><a id='next' href='#'>Winter Edition</a></h6>
                <h6><a id='next' href='#'>Discount</a></h6>
              </div>
              <div className='col-md-2'>
                <h5>COMPANY</h5>
                <h6><a id='next' href='#'>About Us</a></h6>
                <h6><a id='next' href='#'>Contact</a></h6>
                <h6><a id='next' href='#'>Afflicates</a></h6>
              </div>
              <div className='col-md-2'>
                <h5>SUPPORT</h5>
                <h6><a id='next' href='#'>FAQs</a></h6>
                <h6><a id='next' href='#'>Cookie Policy</a></h6>
                <h6><a id='next' href='#'>Terms of Use</a></h6>
              </div>
              <div className='col-md-3'>
